...
├── style.css               # 設計變數、RWD、深色模式與視覺樣式
├── main.js                 # 導覽、輪播、打字、計數、篩選、FAQ 等互動
├── logo-y.png              # 品牌商標(淺色底用,自向量原稿產生 256px)
├── logo-y-white.png        # 品牌商標(深色底用)
├── logo-nav.png            # 舊版導覽列品牌圖(保留)
├── og-image.jpg            # 社群分享圖片
├── favicon.ico             # 瀏覽器圖示
├── favicon-32x32.png
├── favicon-64x64.png
...
樣式與腳本以 `?v=` 版本參數引用。**改版後請一併更新 `index.html` 裡的版本字串**,
否則回訪者的瀏覽器會沿用快取中的舊 CSS/JS。
